...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tldap_counters', 'scheme',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=20, db_index=True),
                      keep_default=False)
    ...
    models = {
        u'methods.counters': {
            ...
            'scheme': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'})
        }
    }
